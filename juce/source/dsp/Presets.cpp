...
const std::vector<Preset>& factoryPresets() {
    static const std::vector<Preset> presets = {
        ...
        {"VELVET PAD", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", -1.4f}, {"fx.eq.mid", -1.3f}, {"fx.eq.mfreq", 405}, {"fx.eq.high", 2.7f},
        }},
        ...
        {"CRYSTAL PLUCK", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 6.0f}, {"fx.eq.mid", 4.5f}, {"fx.eq.mfreq", 709}, {"fx.eq.high", -6.0f},
        }},
        ...
        {"HYPER SAW", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 5.6f}, {"fx.eq.mid", 6.0f}, {"fx.eq.mfreq", 598}, {"fx.eq.high", -6.0f},
        }},
        ...
        {"VOWEL TALK", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 5.1f}, {"fx.eq.mid", 5.0f}, {"fx.eq.mfreq", 916}, {"fx.eq.high", -6.0f},
        }},
        ...
        {"CATHEDRAL BELL", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 6.0f}, {"fx.eq.mid", 5.0f}, {"fx.eq.mfreq", 693}, {"fx.eq.high", -6.0f},
        }},
        ...
        {"NEURO WOBBLE", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", -3.2f}, {"fx.eq.mid", 2.8f}, {"fx.eq.mfreq", 356}, {"fx.eq.high", 0.5f},
        }},
        ...
        {"POWER FIFTHS", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 5.9f}, {"fx.eq.mid", 6.0f}, {"fx.eq.mfreq", 601}, {"fx.eq.high", -6.0f},
        }},
        ...
        {"GROWL BASS", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", -6.0f}, {"fx.eq.mid", -5.0f}, {"fx.eq.mfreq", 620}, {"fx.eq.high", 6.0f},
        }},
        ...
        {"FUTURE CHORD", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 6.0f}, {"fx.eq.mid", 6.0f}, {"fx.eq.mfreq", 431}, {"fx.eq.high", -6.0f},
        }},
        ...
        {"SCREECH LEAD", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 6.0f}, {"fx.eq.mid", 2.3f}, {"fx.eq.mfreq", 734}, {"fx.eq.high", -6.0f},
        }},
        ...
        {"HOUSE PLUCK", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 4.6f}, {"fx.eq.mid", -6.0f}, {"fx.eq.mfreq", 504}, {"fx.eq.high", 1.4f},
        }},
        ...
        {"TRAP BELL", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 6.0f}, {"fx.eq.mid", 4.0f}, {"fx.eq.mfreq", 680}, {"fx.eq.high", -6.0f},
        }},
        ...
        {"DARK DRONE", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", -5.9f}, {"fx.eq.mid", -4.4f}, {"fx.eq.mfreq", 361}, {"fx.eq.high", 6.0f},
        }},
        ...
        {"WUB BASS", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 0.1f}, {"fx.eq.mid", 5.5f}, {"fx.eq.mfreq", 493}, {"fx.eq.high", -5.6f},
        }},
        ...
        {"GLIDE LEAD", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 1.9f}, {"fx.eq.mid", -4.7f}, {"fx.eq.mfreq", 546}, {"fx.eq.high", 2.8f},
        }},
        ...
        {"DYNO EPIANO", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 1.9f}, {"fx.eq.mid", 2.1f}, {"fx.eq.mfreq", 443}, {"fx.eq.high", -4.0f},
        }},
        ...
        {"ROCK ORGAN", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", -2.8f}, {"fx.eq.mid", 3.1f}, {"fx.eq.mfreq", 410}, {"fx.eq.high", -0.3f},
        }},
        ...
        {"ANALOG STRINGS", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 3.2f}, {"fx.eq.mid", 2.7f}, {"fx.eq.mfreq", 467}, {"fx.eq.high", -5.9f},
        }},
        ...
        {"CINEMA STRINGS", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", -0.1f}, {"fx.eq.mid", 1.0f}, {"fx.eq.mfreq", 392}, {"fx.eq.high", -0.9f},
        }},
        ...
        {"BRASS SECTION", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 6.0f}, {"fx.eq.mid", 6.0f}, {"fx.eq.mfreq", 547}, {"fx.eq.high", -6.0f},
        }},
        ...
        {"SOFT BRASS", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", 1.7f}, {"fx.eq.mid", 1.8f}, {"fx.eq.mfreq", 443}, {"fx.eq.high", -3.5f},
        }},
        ...
        {"NYLON PLUCK", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", -5.0f}, {"fx.eq.mid", -2.7f}, {"fx.eq.mfreq", 276}, {"fx.eq.high", 6.0f},
        }},
        ...
        {"CELTIC HARP", {
            ...
            {"fx.eq.on", 1}, {"fx.eq.low", -6.0f}, {"fx.eq.mid", -0.9f}, {"fx.eq.mfreq", 273}, {"fx.eq.high", 6.0f},
        }},
    };
    return presets;
}
