...
enum BassPid : int {
    ...
    BL_FXCOMP_ON, BL_FXCOMP_THR,
    BL_FXOTT_ON, BL_FXOTT_DEPTH, BL_FXOTT_TIME, BL_FXOTT_UP, BL_FXOTT_DOWN,
    // Appended four-band EQ, matching WT-1 descriptor order.
    BL_FXEQ_ON, BL_FXEQ_LOW, BL_FXEQ_MID, BL_FXEQ_MFREQ, BL_FXEQ_HIGH, BL_FXEQLFREQ, BL_FXEQM2FREQ, BL_FXEQHFREQ, BL_FXEQMID2, BL_FXEQLQ, BL_FXEQLTYPE, BL_FXEQLON, BL_FXEQMQ, BL_FXEQMTYPE, BL_FXEQMON, BL_FXEQM2Q, BL_FXEQM2TYPE, BL_FXEQM2ON, BL_FXEQHQ, BL_FXEQHTYPE, BL_FXEQHON,
    BL_FXCOMP_ATT, BL_FXCOMP_REL, BL_FXCOMP_RATIO, BL_FXDRIVE_TONE, BL_FXDRIVE_TYPE,
    BL_NUM_PARAMS // == 78
};
